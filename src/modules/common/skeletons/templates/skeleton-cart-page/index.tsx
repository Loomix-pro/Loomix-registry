...
import SkeletonCartItem from "@/modules/common/skeletons/components/skeleton-cart-item"
import SkeletonCodeForm from "@/modules/common/skeletons/components/skeleton-code-form"
    ...
    <div className="py-12">
      <div className="content-container">
        <div className="grid grid-cols-1 small:grid-cols-[1fr_360px] gap-x-40">
          <div className="flex flex-col bg-transparent p-6 gap-y-6">
