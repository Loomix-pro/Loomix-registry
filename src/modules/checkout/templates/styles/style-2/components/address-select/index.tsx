  ...
  return (
    <Listbox onChange={handleSelect} value={selectedId}>
      <div className="relative">
        ...
        >
          <Listbox.Options
            className="absolute z-20 w-full overflow-auto text-small-regular bg-background border border-border rounded-xl mt-1 shadow-lg max-h-60 focus:outline-none sm:text-sm"
                ...
                >
                  <div className="flex gap-x-4 items-start">
                    ...
                    <div className="flex flex-col">
                      <span className="text-left text-base-semi font-bold">
                      ...
                      <div className="flex flex-col text-left text-base-regular mt-2 text-muted-foreground">
                        <span>
                          {address.address_1}
                          {address.address_2 && (
