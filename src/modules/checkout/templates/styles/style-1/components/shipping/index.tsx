...
function formatAddress(address: HttpTypes.StoreCartAddress | undefined | null) {
  if (!address) {
    return ""
  }
        ...
        <>
          <div className="grid">
            <div className="flex flex-col">
              <span className="font-medium txt-medium text-foreground">
                {t("shipping_method")}
              </span>
              <span className="mb-4 text-muted-foreground txt-medium">
