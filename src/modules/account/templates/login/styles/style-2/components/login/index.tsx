    ...
    <div className="flex flex-col gap-y-4 w-full">
      <form action={loginWithGoogle} className="w-full">
        <Button
          type="submit"
          variant="secondary"
          className="w-full flex items-center justify-center gap-3 py-3.5 bg-white/50 dark:bg-zinc-900/50 hover:bg-white dark:hover:bg-zinc-800 border border-gray-200 dark:border-zinc-700/50 rounded-xl transition-all duration-300 shadow-sm hover:shadow-md text-gray-700 dark:text-gray-200"
        >
          <svg
