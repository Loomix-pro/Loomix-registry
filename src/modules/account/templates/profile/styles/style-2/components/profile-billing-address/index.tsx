...
const ProfileBillingAddress: React.FC<MyInformationProps> = ({
  ...
  const tAddress = useTranslations("Account.AddressBook")
  ...
  const currentInfo = useMemo(() => {
    if (!billingAddress) {
      return tAddress("no_billing_address")
    }
  ...
  }, [billingAddress, regionOptions, tAddress])
